<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm4.aspx.cs" Inherits="MasterPage_PI.WebForm4" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <center>
        <br />
        <asp:Label ID="pagTitulo" runat="server" Text="Sistema de Cadastro de Jogos" Font-Size="20pt" Font-Names="Century Gothic" ForeColor="White" BorderColor="White" BorderStyle="Solid" Visible="False"></asp:Label>
            <br />
            <br />
            <br />
            <br />
        ...
        <br />
                <br />
                <asp:Label ID="sobreTxt" runat="server" Font-Names="Century Gothic" ForeColor="White" Height="49px" Text="Para cadastrar um jogo preencha o formulário abaixo." Width="384px"></asp:Label>
                <br />
                <br />
